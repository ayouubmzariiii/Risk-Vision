...
import { Shield, BookOpen, Calendar, User, ArrowRight } from 'lucide-react';
      ...
      <section className="bg-gradient-to-br from-blue-50 via-white to-emerald-50 py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <h1 className="text-5xl font-bold text-gray-900 mb-6">
            RiskVision <span className="text-blue-600">Blog</span>
          </h1>
          <p className="text-xl text-gray-600 mb-8 leading-relaxed">
            Insights, best practices, and updates from the world of risk management.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <div className="bg-gray-50 rounded-lg p-12">
            ...
            <p className="text-lg text-gray-600 mb-8">
              We're working on bringing you valuable insights about risk management, 
              project planning, and team collaboration. Stay tuned for expert articles, 
